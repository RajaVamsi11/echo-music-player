...
import com.example.vamsi.echo.CurrentSongHelper
import com.example.vamsi.echo.R
import com.example.vamsi.echo.Songs
import com.example.vamsi.echo.databases.EchoDatabase
import java.util.*
...
class SongPlayingFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater?, container: ViewGroup?,
        ...
        Statified.shuffleImageButton = view?.findViewById(R.id.shufffleButton)
